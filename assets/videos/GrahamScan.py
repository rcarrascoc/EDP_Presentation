        ...
        def read_off(file_path):
            with open(file_path, 'r') as file:
                ...
                for _ in range(num_vertices):
                    ...
                    vertices.append(vertex[:2])  # Tomamos solo las dos primeras coordenadas para 2D

            return np.array(vertices)

        # Ejemplo de uso
        file_path = 'all_points.off'  # Reemplaza 'tu_archivo.off' con la ruta de tu archivo .off
